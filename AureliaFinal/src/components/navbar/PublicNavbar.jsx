        ...
        <Container>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
              <a href="tel:+84386062358" style={{ color: 'rgba(255,255,255,0.65)', fontSize: '0.78rem', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '6px', letterSpacing: '0.3px' }}>
                <FaPhone style={{ color: '#C5A059', fontSize: '0.7rem' }} /> +84 386 062 358
              </a>
