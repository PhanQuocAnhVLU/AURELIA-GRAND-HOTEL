  ...
  <Modal show={show} onHide={onHide} centered size="sm">
    <div style={{ background: '#0F172A', border: '1px solid rgba(197,160,89,0.3)', borderRadius: '4px', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '20px 32px 32px' }}>
        ...
        <a href="tel:+84386062358" style={{ display: 'flex', alignItems: 'center', gap: '10px', background: 'linear-gradient(135deg, #C5A059, #A07840)', color: '#fff', textDecoration: 'none', padding: '13px 24px', fontSize: '0.82rem', letterSpacing: '1.5px', fontWeight: 600, textTransform: 'uppercase', marginBottom: '10px' }}>
          <FaPhone style={{ fontSize: '0.75rem' }} /> +84 386 062 358
        </a>
      ...
      <div style={{ background: '#0F172A', padding: '60px 0', borderTop: '3px solid #C5A059', textAlign: 'center' }}>
        <Container>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', flexWrap: 'wrap' }}>
            <a href="tel:+84386062358" style={{ background: 'linear-gradient(135deg, #C5A059, #A07840)', color: '#fff', textDecoration: 'none', padding: '14px 36px', fontSize: '0.8rem', letterSpacing: '2px', fontWeight: 600, textTransform: 'uppercase' }}>
              Gọi Ngay
            </a>
