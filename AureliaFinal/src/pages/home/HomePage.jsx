...
import HotelDirections from '../../components/common/HotelDirections';
  ...
  return (
    <div style={{ position: 'relative', overflowX: 'hidden' }}>
          ...
          <Row className="align-items-center g-5">
            <Col lg={6}>
              ...
              <p style={{ color: '#64748B', lineHeight: 1.9, fontSize: '0.95rem', marginBottom: '28px' }}>
                Tọa lạc tại Quận Tân Phú, AURELIA GRAND HOTEL mang đến trải nghiệm lưu trú 5 sao với sự kết hợp tinh tế giữa kiến trúc cổ điển Pháp và thiết kế nội thất đương đại. Mỗi chi tiết đều phản ánh sự chú trọng đến tính hoàn hảo.
              </p>
      ...
      {/* ══════════════════════════════════════
          BẢN ĐỒ
      ══════════════════════════════════════ */}
      <section style={{ background: '#070E1C', paddingTop: '72px', paddingBottom: '0' }}>
        <Container>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <p style={{ fontSize: '0.72rem', letterSpacing: '4px', color: '#C5A059', textTransform: 'uppercase', fontFamily: "'Cormorant Garamond', serif", marginBottom: '12px' }}>
              Tìm Chúng Tôi
            </p>
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: 600, color: '#fff', marginBottom: '12px' }}>
              Vị Trí Khách Sạn
            </h2>
            <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.9rem', maxWidth: '480px', margin: '0 auto' }}>
              Đường Tây Sơn, Quận Tân Phú, TP. Hồ Chí Minh
            </p>
          </div>

          <HotelDirections />

          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', flexWrap: 'wrap', padding: '28px 0 48px', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
            {[
              { icon: <FaMapMarkerAlt />, text: 'Đường Tây Sơn, Quận Tân Phú' },
              { icon: <FaPhone />, text: '+84 386 062 358' },
              { icon: <FaEnvelope />, text: 'info@aureliagrand.vn' },
            ].map(({ icon, text }, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px', color: 'rgba(255,255,255,0.5)', fontSize: '0.85rem' }}>
          ...
          <Row className="g-5 mb-5">
            ...
            <Col md={4}>
              ...
              <p style={{ fontSize: '0.85rem', lineHeight: 1.8, maxWidth: '280px', marginBottom: '24px' }}>
                Tọa lạc tại Quận Tân Phú, TP.HCM — nơi hội tụ của sự sang trọng, hiếu khách và tinh hoa văn hóa.
              </p>
              {/* Social */}
            ...
            <Col md={4}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <span style={{ fontSize: '0.85rem', lineHeight: 1.7 }}>Đường Tây Sơn, Quận Tân Phú, TP. Hồ Chí Minh</span>
                </div>
                <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                  <FaPhone style={{ color: '#C5A059', flexShrink: 0 }} />
                  <a href="tel:+84386062358" style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.55)', textDecoration: 'none' }}>+84 386 062 358</a>
                </div>
                <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
